...
export const ABOUT_PARAGRAPHS = [
  ...
  "At Altis Technology Services, we are committed to ensuring the confidentiality, integrity, and availability of your critical information, ensuring you have the peace of mind that your digital environment remains resilient and secure.",
] as const;
...
export const ABOUT_CTA_DESCRIPTION =
  "Altis Technology Services enables your organization to gain a competitive advantage by focusing on your business goals instead of being in the mire of cyber security and IT environment management. Contact Altis Technology Services today to discover how we deliver the best solutions.";
